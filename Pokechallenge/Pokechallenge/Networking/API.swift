...
public final class PokemonQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct AllPokemon: GraphQLSelectionSet {
      ...
      public init(id: Int? = nil, name: String? = nil, generation: String? = nil, color: String? = nil, genus: String? = nil, types: [`Type`?]? = nil, sprites: Sprite? = nil, pokedexEntries: [PokedexEntry?]? = nil, evolvesTo: [EvolvesTo?]? = nil) {
